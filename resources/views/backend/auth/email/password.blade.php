                ...
                <table cellspacing="0" cellpadding="0" width="700" class="w320">
                    <tr>
                        <td class="free-text">
                            ...
                            To change your password, please visit the following url: <br><br>

                            <a href="{{ url("auth/reset-password/{$user->getUserId()}/{$code}") }}">{{ url("auth/reset-password/{$user->getUserId()}/{$code}") }}</a>
                            <br><br>
