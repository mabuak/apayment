        ...
        <div class="panel panel-visible">
            <div class="panel-heading">
                <div class="panel-title hidden-xs">
                    <span class="glyphicon glyphicon-tasks"></span>@lang('auth.form_role_add_title')
                </div>
            </div>
            ...
            <form action="{{route('role.store')}}" method="post">
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control input-sm" placeholder="@lang('auth.form_role_name_label')" value="{{ old('name') }}">
                ...
                <div class="panel-footer">
                    ...
                    <div class="pull-right">
                        <button type="submit" class="btn ladda-button btn-success btn-sm" data-style="zoom-in">
                            <span class="ladda-label"><i class="fa fa-save"></i> @lang('auth.form_role_add_submit_btn')</span>
