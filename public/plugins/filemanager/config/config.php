...
if(isset($_GET['text'])){
    $folder = base64_decode($_GET['text']);
    $subFolder = explode("@", $folder, 2);
    $_SESSION["RF"]["subfolder"] = str_replace('.', '', $subFolder[0]);
}
...
$config = array(
    ...
    */
    ...
    |
    */
    'upload_dir'       => '/rfq-module/public/uploads/',
    ...
    */
    ...
    'access_keys'                             => array(md5(date('Y-m-d') . 'a9c1OkE1')),
